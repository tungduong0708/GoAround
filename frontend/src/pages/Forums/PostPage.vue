              ...
              <div class="flex items-start justify-between">
                <div class="flex items-center gap-3">
                  <RouterLink :to="`/users/${post.author.id}`">
                    <Avatar
                      class="size-12 border-2 border-background shadow-sm hover:opacity-80 transition-opacity cursor-pointer"
                    >
                      <AvatarImage
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      >
                        <span class="font-bold text-foreground">
                          {{
                            post.author.is_verified_business
              ...
              <div v-if="replies.length > 0" class="space-y-2">
                ...
                >
                  ...
                  <div
                    ...
                    class="p-4 rounded-2xl bg-card border-2 border-orange-500 shadow-lg"
                  >
                    <!-- Editing Mode -->
                    <div class="space-y-3">
                      <div
                        class="flex items-center gap-2 text-sm font-medium text-orange-600"
                      >
                  ...
                  <div
                    v-if="isReplyEditorOpen && replyingToId === reply.id"
                    class="ml-8 mt-2"
                  >
                    <ForumReplyEditor
                      v-model="replyContent"
                      ...
                      :is-submitting="repliesLoading"
                      :can-submit="
                        replyFormMeta.valid && !!replyContent?.trim()
                      "
                      :cooldown-seconds="canReply ? 0 : timeUntilCanReply"
                  ...
                  >
                    ...
                    >
                      <div
                        v-if="editingReplyId === nestedReply.id"
                        class="p-4 rounded-2xl bg-card border-2 border-orange-500 shadow-lg"
                      >
                        <!-- Editing Mode -->
                        <div class="space-y-3">
                      ...
                      <div
                        v-if="
                          isReplyEditorOpen && replyingToId === nestedReply.id
                        "
                        class="ml-4 mt-2"
                      >
                        <ForumReplyEditor
