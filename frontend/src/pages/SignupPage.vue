...
<template>
  <div class="min-h-screen w-full bg-background text-foreground px-4 py-12 sm:py-16 flex flex-col items-center gap-6">
    <div class="flex flex-col items-center gap-3 text-center">
      ...
      <h1 class="text-2xl font-semibold text-foreground">Create your GoAround account</h1>
      <p class="text-sm text-muted-foreground">Start planning your adventures today</p>
    </div>
    ...
    <Card class="w-full max-w-md border border-border bg-card text-card-foreground shadow-xl shadow-foreground/5">
      <CardHeader class="space-y-1 text-center">
        ...
        <CardDescription>Sign up with Google or create a new account with your email.</CardDescription>
      </CardHeader>
