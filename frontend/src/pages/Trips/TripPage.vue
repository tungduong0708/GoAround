                  ...
                  <div class="flex-1 min-w-0 flex flex-col gap-1.5">
                    ...
                    >
                      ...
                      >
                        ...
                        <span>{{ stop.place.averageRating.toFixed(1) }}</span>
                      </div>
                    </div>
                    ...
                    >
                      ...
                      <span class="text-muted-foreground">
                        {{ stop.place.reviewCount }} reviews
                      </span>
                    </div>

                    <!-- Stop Info -->
                    <div
                      v-if="stop.arrivalTime || stop.notes"
                    ...
                    >
                      ...
                      >
                        ...
                        <span>{{ formatArrivalTime(stop.arrivalTime) }}</span>
                      </div>
                      <p
                        v-if="stop.notes"
